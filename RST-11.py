    ...
    def show_alien():
        ...
        for alien_number in range (len(aliens)):
            ...
            if aliens[alien_number].x < 0:
                ...
                aliens[alien_number].move(random.randint(0 + constants.SPRITE_SIZE, constants.SCREEN_GRID_X - constants.SPRITE_SIZE), constants.OFF_TOP_SCREEN)
                break
